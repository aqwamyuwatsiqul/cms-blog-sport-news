...
<body class="w3-light-grey">
    ...
    <div class="w3-content" style="max-width:1400px; margin-top:50px">
        ...
        <header class="w3-container w3-center w3-padding-64 header-background">
            ...
            $sql = "SELECT admin.id_admin, admin.id_kategori, article.id_artikel, article.tanggal, article.judul, article.isi, article.gambar, users.name, category.nama_kategori, admin.id_kategori, category.keterangan
                    FROM admin 
                    ...
                    WHERE admin.id_kategori = '$id_kategori_terpilih'
                    ORDER BY admin.id_kategori DESC LIMIT 1";
            ...
            ?>
                    <h1><b><?php echo $nama_kategori?></b></h1>
                    <p><span class="w3-tag"> <?php echo $keterangan; ?> </span></p>
            <?php
                }
            }
            ?>
            ...
            <div class="w3-col l8 s12">
                ...
                function potong_isi($isi_artikel, $jml_karakter)
                {
                    if (strlen($isi_artikel) <= $jml_karakter) {
                        return $isi_artikel; // Jika panjang isi artikel kurang dari atau sama dengan jumlah karakter yang diminta, kembalikan artikel secara penuh
                    }
                    ...
                    if ($jml_karakter == 0) {
                        return substr($isi_artikel, 0, 250) . " ...."; // Jika tidak menemukan spasi, potong pada karakter ke-250
                    }
                ...
                $sql = "SELECT admin.id_admin, admin.id_kategori, article.id_artikel, article.tanggal, article.judul, article.isi, article.gambar, users.name, category.nama_kategori, admin.id_kategori
                        ...
                        JOIN category ON admin.id_kategori = category.id_kategori
                        WHERE admin.id_kategori = '$id_kategori_terpilih'
                        ORDER BY admin.id_kategori DESC";
                $result = mysqli_query($conn, $sql);
                $nomor = 1;
